...
public class KnightMcKrispie{                                // character sprites 42 x 21 in

	public static void main(String[] args)  throws Exception {
//Play BG theme 
	//Get current directory where file is located
    // open the sound file as a Java input stream
    String gongFile = System.getProperty("user.dir") + File.separator + "Zelda_Main_Theme_Song.wav";
  ...
  //BG Theme
    ...
    // open the sound file as a Java input stream
    String songFile = System.getProperty("user.dir") + File.separator + "the_legend_of_zelda_NES_music_-_game_over_theme.wav";
  ...
  //Game Over theme
    ...
    String credit = System.getProperty("user.dir") + File.separator + "Legend_of_Zelda_Ocarina_of_Time-_Credits.wav";
  ...
  // credit song
		...
		if(player.getXposition() == bowser.getXposition()){
			...
			AudioPlayer.player.stop(audioStream); //Ends music
			AudioPlayer.player.start(gameOver); //Game over music plays 
			movie.frameFinished();
			return; //Game Ends
		}
		...
		AudioPlayer.player.stop(audioStream); //Ends music
		AudioPlayer.player.start(credits); //Credit song plays
